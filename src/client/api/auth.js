...
const containerStyle = {display: "flex", justifyContent: "center", alignItems: "center", width: "100%", background: "white"}
...
export function SignOutButton() {
  return (
    <div style={containerStyle}>
      <button onClick={() => { auth.signOut() }} className="button is-family-code">Sign Out</button>
    </div>
  )
}